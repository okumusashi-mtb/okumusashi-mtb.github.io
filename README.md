...
- **②** その記録から、会のウェブサイトを組み立てて公開し、会の Google カレンダーに予定を登録します。
  カレンダーはウェブサイトにも表示されます。
...
- **街てこり（city.tecoli.com）** にも会のページ `https://city.tecoli.com/ideas/okumusashi-mtb/` があり、
...
> **リポジトリ名は変えないでください。** GitHub Pages がサイトをドメイン直下で配信するのは、
